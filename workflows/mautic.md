...
description: "Marketing automation and campaign integration."
trigger: "/mautic"
---

# Mautic Marketing Automation Workflow

## Overview
This workflow utilizes the globally integrated `@mautic` skill to interact with the repository.
