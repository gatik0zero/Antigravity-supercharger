...
description: "Open source accounting integration and module development."
trigger: "/akaunting"
---

# Akaunting Setup Workflow

## Overview
This workflow utilizes the globally integrated `@akaunting` skill to interact with the repository.
