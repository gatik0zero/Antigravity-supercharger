...
description: "Team knowledge base setup and markdown documentation."
trigger: "/outline"
---

# Outline Knowledge Base Workflow

## Overview
This workflow utilizes the globally integrated `@outline` skill to interact with the repository.
